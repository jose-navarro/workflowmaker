/** \file to_uppercase_options_file_reader.hpp
\brief Reader for to_uppercase option files.
*/

#ifndef TO_UPPERCASE_OPTIONS_FILE_READER_HPP
#define TO_UPPERCASE_OPTIONS_FILE_READER_HPP
...
class to_uppercase_options_file_reader
{
  public:

    /// \brief Default constructor.

            to_uppercase_options_file_reader  (void);
   ...
   /**
     ...
     \return An error code:
        ...
        - 2: Missing or mispelled option in the options file: TO_UPPERCASE_INPUT_FILENAME.
        - 3: Missing or mispelled option in the options file: TO_UPPERCASE_OUTPUT_FILENAME.
     */
...
#endif // TO_UPPERCASE_OPTIONS_FILE_READER_HPP
