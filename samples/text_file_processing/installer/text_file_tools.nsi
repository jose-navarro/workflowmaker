...
!define defProductName     "WorkflowMaker_text_processing_samples"
...
Section "Sample text file tools for Workflowmaker"
  ...
  File ${InstallFrom}\x64\append.exe
  File ${InstallFrom}\x64\cut_tail.exe
  File ${InstallFrom}\x64\interleave.exe
  File ${InstallFrom}\x64\reverse.exe
  File ${InstallFrom}\x64\to_uppercase.exe
...
Section "Source code for the tools"
  ...
  SetOutPath $INSTDIR\src\tasks\append
  File /r "..\tasks\append\src\*.cpp"
  File /r "..\tasks\append\src\*.hpp"
  
  SetOutPath $INSTDIR\src\tasks\cut_tail
  File /r "..\tasks\cut_tail\src\*.cpp"
  File /r "..\tasks\cut_tail\src\*.hpp"
  
  SetOutPath $INSTDIR\src\tasks\interleave
  File /r "..\tasks\interleave\src\*.cpp"
  File /r "..\tasks\interleave\src\*.hpp"
  
  SetOutPath $INSTDIR\src\tasks\reverse
  File /r "..\tasks\reverse\src\*.cpp"
  File /r "..\tasks\reverse\src\*.hpp"
  
  SetOutPath $INSTDIR\src\tasks\to_uppercase
  File /r "..\tasks\to_uppercase\src\*.cpp"
  File /r "..\tasks\to_uppercase\src\*.hpp"
...
Section "User guides"
  ...
  SetShellVarContext all
  CreateShortCut "$SMPROGRAMS\${defProductName}\${defProductName} User guides folder.lnk" "$INSTDIR\docs" "" "$INSTDIR\docs" 0
