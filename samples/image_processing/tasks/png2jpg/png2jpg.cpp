...
/// \brief Converts a png image into a jpg one.
...
{
  {
    try
    {
      ...
      png2jpg_options_file_reader op_reader;
      ...
      // Check that the input file name ends in any of the valid png extensions.
      ...
      // Check that the output file name ends in any of the valid jpg extensions.
