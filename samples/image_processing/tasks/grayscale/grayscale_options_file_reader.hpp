/** \file grayscale_options_file_reader.hpp
\brief Reader for grayscale option files.
*/

#ifndef GRAYSCALE_OPTIONS_FILE_READER_HPP
#define GRAYSCALE_OPTIONS_FILE_READER_HPP
...
struct grayscale_options
{
  ...
  string         output_filename; /**< Path and name of the output image that will
                                       store the output grayscale image.          */
};

/// \brief Reader for grayscale option files.

class grayscale_options_file_reader
{
  public:
    ...
    grayscale_options_file_reader  (void);
    ...
    /// \brief Parses the contents of a grayscale options file,
    /// storing the results memory for easy access.
   /**
     \param options_file Name of the grayscale options file to parse.
     \param options The structure where the options will be stored.
     \return An error code:
        - 0: Successful completion.
        - 1: Syntax errors found while parsing the grayscale options file.
        - 2: Missing or mispelled option in in grayscale options file: INPUT_FILENAME.
        - 3: Missing or mispelled option in grayscale options file: OUTPUT_FILENAME.
     */
...
#endif // GRAYSCALE_OPTIONS_FILE_READER_HPP
