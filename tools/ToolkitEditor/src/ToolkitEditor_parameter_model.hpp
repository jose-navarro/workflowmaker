/** \file ToolkitEditor_parameter_model.cpp
  \brief Table view model for lists of parameters.
*/

#ifndef TOOLKITEDITOR_PARAMETER_MODEL_HPP
#define TOOLKITEDITOR_PARAMETER_MODEL_HPP
...
class ToolkitEditor_parameter_model : public QAbstractTableModel
{
  public:

    /**
      \brief Add a new row.
      \param parameter The parameter to add in the new row.
     */

    void          append_row               (toolkit_parameter& parameter);
    ...
    /**
      \brief Constructor.
      \param parameters Pointer to the list of parameters to handle.
      \param parent The parent widget.
     */

                  ToolkitEditor_parameter_model (QList<toolkit_parameter>* parameters, QObject *parent = nullptr);
...
#endif // TOOLKITEDITOR_PARAMETER_MODEL_HPP
