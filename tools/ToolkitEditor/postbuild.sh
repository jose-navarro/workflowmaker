...
# Copy the toolkit schema to the destination share folder.

cp ../../data/toolkit.xsd ../../installer/installer_sw_linux/workflowmaker_x.y-zz_amd64/usr/share/workflowmaker/
