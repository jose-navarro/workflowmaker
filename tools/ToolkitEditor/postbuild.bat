...
@ECHO INSTALLER'S DEPLOYMENT FOLDERS: Copying ToolkitEditor's schema

COPY ..\..\data\toolkit.xsd ..\..\installer\installer_sw_windows\deployment\data\toolkit.xsd

@ECHO INSTALLER'S DEPLOYMENT FOLDERS: Copying ToolkitEditor's sample
