/** \file toolkit_parser_message_handler.hpp
\brief Error handler for XML validation against the toolkit schema.
*/

#ifndef TOOLKIT_PARSER_MESSAGE_HANDLER_HPP
#define TOOLKIT_PARSER_MESSAGE_HANDLER_HPP
...
/// \brief Handle schema validation errors for toolkit XML files.

class toolkit_parser_message_handler : public QAbstractMessageHandler
{
  public:
    ...
    /**
      ...
      */
           ...
           toolkit_parser_message_handler (void);
...
#endif // TOOLKIT_PARSER_MESSAGE_HANDLER_HPP
