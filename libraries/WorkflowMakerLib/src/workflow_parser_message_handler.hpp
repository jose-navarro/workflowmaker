/** \file workflow_parser_message_handler.hpp
\brief Error handler for XML validation against the workflow schema.
*/

#ifndef WORKFLOW_PARSER_MESSAGE_HANDLER_HPP
#define WORKFLOW_PARSER_MESSAGE_HANDLER_HPP
...
/// \brief Handle schema validation errors for workflow XML files.

class workflow_parser_message_handler : public QAbstractMessageHandler
{
  public:
    ...
    /**
      ...
      */
           ...
           workflow_parser_message_handler (void);
