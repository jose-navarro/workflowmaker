...
build_deb_folder_structure() {
  ...
  cp ../../installer/installer_sw_linux/control  ../../installer/workflowmaker_x.y-zz_amd64/debian/

  # Copy the files that must be stored in the DEBIAN folder. Set their permissions.

  cp ../../installer/installer_sw_linux/control  ../../installer/workflowmaker_x.y-zz_amd64/DEBIAN/
  cp ../../installer/installer_sw_linux/postinst ../../installer/workflowmaker_x.y-zz_amd64/DEBIAN/
  cp ../../installer/installer_sw_linux/prerm    ../../installer/workflowmaker_x.y-zz_amd64/DEBIAN/
  ...
  cp ../../installer/installer_sw_linux/find_dependencies.sh ../../installer/workflowmaker_x.y-zz_amd64/

  chmod +x ../../installer/workflowmaker_x.y-zz_amd64/find_dependencies.sh
}
